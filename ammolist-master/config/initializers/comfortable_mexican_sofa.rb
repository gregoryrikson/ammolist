# encoding: utf-8
ComfortableMexicanSofa::Configuration.module_eval { 
  attr_accessor :admin_route_path
  attr_accessor :cms_route_path
}

ComfortableMexicanSofa.configure do |config|
  config.admin_route_path = '/admin/blog'
  config.cms_route_path = '/blog'
...
ComfortableMexicanSofa::AccessControl::AdminAuthentication.password = '272mptjg72'
