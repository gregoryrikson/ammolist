class ComfortableMexicanSofa::Tag::Asset
  ...
  def content
    ...
    case type
    when 'css'
      out = ComfortableMexicanSofa.config.cms_route_path+"/cms-css/#{blockable.site.id}/#{identifier}/#{layout.cache_buster}.css"
      out = "<link href='#{out}' media='screen' rel='stylesheet' type='text/css' />" if format == 'html_tag'
      out
    when 'js'
      out = ComfortableMexicanSofa.config.cms_route_path+"/cms-js/#{blockable.site.id}/#{identifier}/#{layout.cache_buster}.js"
