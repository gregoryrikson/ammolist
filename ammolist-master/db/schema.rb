...
ActiveRecord::Schema.define(version: 20151020163604) do
  ...
  create_table "spree_answers", force: true do |t|
  ...
  add_index "spree_answers", ["question_id"], name: "index_spree_answers_on_question_id", using: :btree
