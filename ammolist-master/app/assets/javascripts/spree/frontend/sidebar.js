...
$(function() {
  ...
  sidebar_menu.find('li .js-topic').click(function(e){
    var icon = $(this).find('i');
    if(icon.attr('class') == 'icon-right-open'){
      icon.removeClass('icon-right-open').addClass('icon-down-open');
      sidebar_menu.find('a.active').removeClass('active');
  ...
  if(active_menu.parent().next().attr('class') == 'js-guides'){
    ...
    active_menu.parent().parent().parent().parent().parent().show();
    active_menu.parent().parent().parent().parent().show();
    active_menu.parent().parent().parent().show();
    var icon = active_menu.parent().parent().parent().find('i');
    if(icon.attr('class') == 'icon-right-open'){
      icon.removeClass('icon-right-open').addClass('icon-down-open');
    }
    active_menu.parent().parent().show();
    var icon = active_menu.parent().parent().find('i');
    if(icon.attr('class') == 'icon-right-open'){
      icon.removeClass('icon-right-open').addClass('icon-down-open');
    }
  }
