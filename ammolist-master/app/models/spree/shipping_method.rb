module Spree
  class ShippingMethod < Spree::Base
    ...
    has_many :shipping_constraints, :dependent => :destroy
    has_many :constraint_types, through: :shipping_constraints
    accepts_nested_attributes_for :shipping_constraints
    has_many :shipping_method_upgrades, :dependent => :destroy
    has_many :shipping_upgrades, through: :shipping_method_upgrades
